...
/* Class declaration for the mkDCT1 module */
class MOD_mkDCT1 : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkDCT1(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  tUInt8 DEF_stage_EQ_3___d44;
  tUInt8 DEF_x__h1809;
 
 /* Local definitions */
 private:
  tUInt32 DEF_b__h1468;
  tUInt32 DEF_b__h1570;
  tUInt32 DEF_b__h1672;
  tUInt32 DEF_b__h1774;
  tUInt32 DEF_b__h1756;
  tUInt32 DEF_b__h1654;
  tUInt32 DEF_b__h1552;
  tUInt32 DEF_b__h1443;
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkDCT1 &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkDCT1 &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkDCT1 &backing);
  void vcd_submodules(tVCDDumpType dt, unsigned int levels, MOD_mkDCT1 &backing);
};

#endif /* ifndef __mkDCT1_h__ */

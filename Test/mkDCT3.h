...
/* Class declaration for the mkDCT3 module */
class MOD_mkDCT3 : public Module {
 ...
 public:
  ...
  MOD_mkCosineLUT INST_lut_0;
  MOD_mkCosineLUT INST_lut_1;
  MOD_Reg<tUInt8> INST_stage;
  MOD_ConfigReg<tUInt32> INST_x_0;
  MOD_ConfigReg<tUInt32> INST_x_1;
  MOD_ConfigReg<tUInt32> INST_x_2;
  MOD_ConfigReg<tUInt32> INST_x_3;
  MOD_ConfigReg<tUInt32> INST_x_4;
  MOD_ConfigReg<tUInt32> INST_x_5;
  MOD_ConfigReg<tUInt32> INST_x_6;
  MOD_ConfigReg<tUInt32> INST_x_7;
 
 /* Constructor */
 public:
  MOD_mkDCT3(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  tUInt8 DEF_stage_EQ_3___d62;
  tUInt8 DEF_x__h1608;
 
 /* Local definitions */
 private:
  tUInt32 DEF_x_7_read____d9;
  tUInt32 DEF_b__h1596;
  tUInt32 DEF_b__h1535;
  tUInt32 DEF_x_4_read____d5;
  tUInt32 DEF_b__h1980;
  tUInt32 DEF_b__h1963;
  tUInt32 DEF_b__h1463;
  tUInt32 DEF_b__h1452;
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkDCT3 &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkDCT3 &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkDCT3 &backing);
  void vcd_submodules(tVCDDumpType dt, unsigned int levels, MOD_mkDCT3 &backing);
};

#endif /* ifndef __mkDCT3_h__ */

...
/* Class declaration for the mkDCT4 module */
class MOD_mkDCT4 : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkDCT4(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  tUInt8 DEF_stage_EQ_2___d45;
  tUInt8 DEF__read__h1047;
 
 /* Local definitions */
 private:
  tUInt32 DEF_b__h1550;
  tUInt32 DEF_b__h1633;
  tUInt32 DEF_b__h1616;
  tUInt32 DEF_b__h1529;
  tUInt32 DEF_b__h1799;
  tUInt32 DEF_b__h1683;
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkDCT4 &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkDCT4 &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkDCT4 &backing);
  void vcd_submodules(tVCDDumpType dt, unsigned int levels, MOD_mkDCT4 &backing);
};

#endif /* ifndef __mkDCT4_h__ */
